          ...
          <Link className='text-link' to={"/productdetails/" + featuredProduct['id']}>
            <Card className='image-box card'>
              ...
              <Card.Body>
                ...
                {featuredProduct['special_price'] == null ? <p className='product-price-on-card text-secondary'>Price: ${featuredProduct['price']}</p> : <p className='product-price-on-card'>Price: <strike className='text-secondary'>${featuredProduct['price']}</strike>&nbsp; ${featuredProduct['special_price']}</p>}
              </Card.Body>
            </Card>
          </Link>
        </div>
